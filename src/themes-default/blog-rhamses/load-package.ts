...
export const BLOG_RHAMSES_THEME_DIR = THEME_DIR;
...
export function loadBlogRhamsesThemePackage(): ThemePackageRecord {
...
export function loadBlogRhamsesThemeAssets(): Map<string, ArrayBuffer> {
